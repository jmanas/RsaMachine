...
public class TableLayoutConstraints
     ...
     *
     * @param constraints indicates TableLayoutConstraints's position and justification as a string in the form "row,
     *                    column" or "row, column, horizontal justification, vertical justification" or "row 1, column
     *                    1, row 2, column 2". It is also acceptable to delimit the paramters with spaces instead of
     *                    commas.
     */
    ...
    /**
     * Constructs an TableLayoutConstraints a setContramedida of constraints.
     *
     ...
     *
     * @return a string in the form "row 1, column 1, row 2, column 2, horizontal justification, vertical
     * justification"
     */
